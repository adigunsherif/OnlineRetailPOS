...
urlpatterns = [
    ...
    path(
        ...
        auth_views.PasswordChangeView.as_view(
            template_name="registration/change_password.html", success_url="/"
        ),
    ...
    path(
        "dashboard_department/", views.dashboard_department, name="dashboard_department"
    ),
    ...
    path(
        "register/recall_transaction/<recallTransNo>/",
        transaction_views.recallTransaction,
    ...
    path(
        "register/<manual_department>/<amount>/",
    ...
    path(
        "endTransaction/<type>/<value>/",
        transaction_views.endTransaction,
        name="endTransaction",
    ),
    path(
        "endTransaction/<transNo>/",
    ...
    path(
        "transaction_receipt/<transNo>/",
        transaction_views.transactionReceipt,
        name="transactionReceipt",
    ),
    path(
        "transaction_receipt/<transNo>/print/",
