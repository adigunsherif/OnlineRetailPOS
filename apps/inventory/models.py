...
class Product(models.Model):
    department = models.ForeignKey(
        "department", on_delete=models.RESTRICT, null=False, blank=False
    )
    ...
    cost_price = models.DecimalField(
        max_digits=7, decimal_places=2, default=0, null=False
    )
    tax_category = models.ForeignKey(
        "tax", on_delete=models.RESTRICT, null=False, blank=False
    )
    deposit_category = models.ForeignKey(
        "deposit", on_delete=models.RESTRICT, null=False, blank=False
    )
